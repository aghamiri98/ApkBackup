...
import com.aghamiri.apkbackup.MainActivity;
import com.aghamiri.apkbackup.R;
import com.aghamiri.apkbackup.adapter.RestoreListAdapter;
import com.aghamiri.apkbackup.data.Utils;
import com.aghamiri.apkbackup.model.RestoreModel;

import java.util.ArrayList;
import java.util.List;


public class FragmentApkRestore extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_apk_restore, container, false);
    ...
    private AbsListView.MultiChoiceModeListener multiChoiceModeListener = new AbsListView.MultiChoiceModeListener() {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            mode.getMenuInflater().inflate(R.menu.apk_restore_context_menu, menu);
        ...
        public void onDestroyActionMode(ActionMode mode) {
            //ActivityApkBackup.toolbar.setVisibility(View.VISIBLE);
    ...
    private void dialogApkFileOption(final int position) {
        ...
        String[] stringArray = new String[]{"بازگردانی", "اشتراک گذاری", "حذف فایل پشتیبان"};
                    ...
                    case 1:
                       ...
                       // Uri fileUri = Uri.fromFile(r.getFile());
                        Uri fileUri = FileProvider.getUriForFile(
                                getActivity(),
                                "com.aghamiri.apkbackup.provider", //(use your app signature + ".provider" )
                                r.getFile());
